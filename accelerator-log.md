...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=jeffjanderson&repo=tanzu-java-web-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=jeffjanderson&repo=tanzu-java-web-app'
